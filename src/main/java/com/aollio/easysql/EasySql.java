...
import com.aollio.easysql.utility.Parser;
...
public class EasySql {
     ...
     * @return 是否删除成功
     **/
    public static int delete(String tableName, String columnName, String args) throws EasyException {
        int result = 0;
        SpecConnection specConnection = connectionPool.getConnection();
    ...
    public static List query(Class classT, String column, String columnValue, boolean isJoinQuery) throws EasyException {
        SpecConnection specConnection = connectionPool.getConnection();
    ...
    public static <T> List<T> query(String sql, Parser<T> parser) {
        SpecConnection specConnection = connectionPool.getConnection();
        ResultSet resultSet = SqlDao.executeQuery(specConnection.getConnection(), sql);
    ...
    public static class UpdateBuilder {
        ...
        int build() {
            if (classT == null && tableName == null) {
                throw new RuntimeException("UpdateBuilder没有设置表名或者实体类");
            }
